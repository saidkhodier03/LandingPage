...
const createSection = () =>{
    ...
    <div class = "landing__container">
        <h2>Section ${counter}</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi fugit tempora modi voluptate, hic molestiae porro doloribus voluptas blanditiis. Dolores perferendis hic ducimus aut veniam nobis voluptatibus, tempora in nemo!</p>

        <p>Said Ibrahim Khodier , from Mahallt Marhom ,  I Study in faculty of computer and information tanta university , Programming is live style , I am .Net developer & Flutter developer , 
            I am motivate to Machine Learning
        </p>
    </div>
</section>`;
